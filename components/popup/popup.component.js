...
export var PopupComponent = (function () {
    function PopupComponent(popupService) {
        ...
        this.confirmBtnStyle = "npm-package-sunarc-Button";
        this.cancelBtnStyle = "npm-package-sunarc-Button";
        this.mainClass = "container npm-package-sunarc-content-main";
    ...
    PopupComponent.prototype.setOptions = function (options) {
        ...
        if (options.cancleBtnClass != undefined) {
            ...
            this.popupService.options.cancleBtnClass = "npm-package-sunarc-Button";
        }
        ;
        ;
        if (options.confirmBtnClass != undefined) {
            ...
            this.popupService.options.confirmBtnClass = "npm-package-sunarc-Button";
        }
        ;
    ...
    PopupComponent.decorators = [
        { type: Component, args: [{
                    selector: 'popup',
                    template: "<div id=\"npm-package-sunarc-main\"  *ngIf=\"visible\" [ngClass]=\"mainClass\" [ngStyle]=\"mainStyle\"> <div class=\"row\"> <div style=\"display: inline-block;width:100%\"> <div id=\"npm-package-sunarc-well\"  [ngStyle]=\"wellStyle\" class=\"npm-package-sunarc-well npm-package-sunarc-well-sm\">{{popupService.options.header}}</div> </div> <div style=\"margin:20px;\"> <ng-content></ng-content> <div *ngIf=\"popupService.options.showButtons\" style=\"margin-bottom:20px;margin-top:20px;float: right\"> <button id=\"cancelBtn\" [ngClass]=\"cancelBtnStyle\" type=\"reset\" (click)=\"confirmNo()\">{{popupService.options.cancleBtnContent}}</button> <button id=\"confirmBtn\" [ngClass]=\"confirmBtnStyle\"  (click)=\"confirmYes()\">{{popupService.options.confirmBtnContent}}</button> </div> </div> </div> </div>",
                    styles: [".npm-package-sunarc-content-main { position: absolute; border-radius: 3px; background-color: white; z-index: 999; top: 30%; } @keyframes fadeInDown { from { opacity: 0; transform: translate3d(0, -30%, 0); } to { opacity: 1; transform: none; } } @keyframes fadeInLeft { from { opacity: 0; transform: translate3d(-100%, 0, 0); } to { opacity: 1; transform: none; } } @keyframes fadeInRight { from { opacity: 0; transform: translate3d(100%, 0, 0); } to { opacity: 1; transform: none; } } @keyframes fadeInUp { from { opacity: 0; transform: translate3d(0, 100%, 0); } to { opacity: 1; transform: none; } } @keyframes bounceIn { from, 20%, 40%, 60%, 80%, to { animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1); } 0% { opacity: 0; transform: scale3d(0.3, 0.3, 0.3); } 20% { transform: scale3d(1.1, 1.1, 1.1); } 40% { transform: scale3d(0.9, 0.9, 0.9); } 60% { opacity: 1; transform: scale3d(1.03, 1.03, 1.03); } 80% { transform: scale3d(0.97, 0.97, 0.97); } to { opacity: 1; transform: scale3d(1, 1, 1); } } @keyframes bounceInDown { from, 60%, 75%, 90%, to { animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1); } 0% { opacity: 0; transform: translate3d(0, -3000px, 0); } 60% { opacity: 1; transform: translate3d(0, 25px, 0); } 75% { transform: translate3d(0, -10px, 0); } 90% { transform: translate3d(0, 5px, 0); } to { transform: none; } } .npm-package-sunarc-well { min-height: 20px; padding: 19px; margin-bottom: 20px; background-color: #f5f5f5; border: 1px solid #e3e3e3; border-radius: 4px; } .npm-package-sunarc-well blockquote { border-color: #ddd; border-color: rgba(0, 0, 0, 0.15); } .npm-package-sunarc-well-lg { padding: 24px; border-radius: 6px; } .npm-package-sunarc-well-sm { padding: 9px; border-radius: 3px; } .npm-package-sunarc-Button { -moz-box-shadow: inset 0px 1px 0px 0px #ffffff; -webkit-box-shadow: inset 0px 1px 0px 0px #ffffff; box-shadow: inset 0px 1px 0px 0px #ffffff; background-color: #fcfcfc; -moz-border-radius: 6px; -webkit-border-radius: 6px; border-radius: 6px; border: 1px solid #dcdcdc; display: inline-block; cursor: pointer; color: #777777; font-family: Arial; font-size: 15px; font-weight: bold; padding: 6px 24px; text-decoration: none; text-shadow: 0px 1px 0px #ffffff; } .npm-package-sunarc-Button:hover { background-color: #dfdfdf; } .npm-package-sunarc-Button:active { position: relative; top: 1px; } .btn:focus, .btn:active { outline: none !important; } .pull-right { float: right !important; } /*Spaces*/ .margin-bottom-5, .margin-bottom-10, .margin-bottom-20, .margin-bottom-20, .margin-bottom-25, .margin-bottom-30, .margin-bottom-35, .margin-bottom-40, .margin-bottom-50, .margin-bottom-60 { clear: both; } .margin-bottom-5 { margin-bottom: 5px; } .margin-bottom-10 { margin-bottom: 10px; } .margin-bottom-20 { margin-bottom: 20px; } .margin-bottom-25 { margin-bottom: 25px; } .margin-bottom-30 { margin-bottom: 30px; } .margin-bottom-35 { margin-bottom: 35px; } .margin-bottom-40 { margin-bottom: 40px; } .margin-bottom-50 { margin-bottom: 50px; } .margin-bottom-60 { margin-bottom: 60px; } /*Spaces*/ .margin-top-5, .margin-top-10, .margin-top-20, .margin-top-20, .margin-top-25, .margin-top-30, .margin-top-35, .margin-top-40, .margin-top-50, .margin-top-60 { clear: both; } .margin-top-5 { margin-top: 5px; } .margin-top-10 { margin-top: 10px; } .margin-top-20 { margin-top: 20px; } .margin-top-25 { margin-top: 25px; } .margin-top-30 { margin-top: 30px; } .margin-top-35 { margin-top: 35px; } .margin-top-40 { margin-top: 40px; } .margin-top-50 { margin-top: 50px; } .margin-top-60 { margin-top: 60px; } "],
                    host: {
...
//# sourceMappingURL=C:/_git/npm-package-sunarc/src/components/popup/popup.component.js.map